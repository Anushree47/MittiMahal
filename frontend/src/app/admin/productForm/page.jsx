  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gray-100">
      <div className="max-w-xl w-full bg-white shadow-md rounded-xl p-6">
        <h1 className="text-2xl font-bold text-center text-gray-700">Add Product</h1>
  ...
  >
    ...
    <option value="Art and Craft Supplies">Art and Craft Supplies</option>
          ...
          <button
            ...
            className="w-full py-3 text-white bg-blue-600 rounded-md hover:bg-blue-700 disabled:opacity-50"
          >
