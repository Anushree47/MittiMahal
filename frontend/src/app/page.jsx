  ...
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        ...
        Rediscover the Beauty of Clay with<span className="text-blue-600"> Mitti Mahal </span>
        </h1>
        ...
        <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
          ...
          <div className="py-5">
            ...
            <p className="mt-3 text-sm text-gray-800 dark:text-neutral-200">
              <span className="font-bold">⭐ 4.8</span> /5 – from 10k+ satisfied customers
          ...
          <div className="py-5">
            ...
            <p className="mt-3 text-sm text-gray-800 dark:text-neutral-200">
              <span className="font-bold">⭐ 4.4</span>/5 – supporting thousands of artisans
            </p>
            <div className="mt-5">
              {/* Star */}
              <svg
